...
def lambda_handler(event, context):
    ...
    for alarm in filtered_iterator:
        ...
        response = sns.publish(TopicArn='arn:aws:sns:us-east-1:679064942344:auto-recover',Message='No Action Assigned to this Alarm:---->' + alarm['AlarmName'] + '**********Hence Action Added**********')
